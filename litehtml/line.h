...
namespace litehtml {
  ...
  public:
    ...
    bool collapse_top_margin() {
      return (m_padding_top == 0);
    }
    bool collapse_bottom_margin() {
      return (m_padding_bottom == 0);
    }
    ...
    void set_line_height(int val) {
      m_min_height = val;
    }

    element_clear get_clear_floats() const {
      return m_clear;
    }
