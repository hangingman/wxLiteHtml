...
namespace litehtml {
  ...
  public:
    ...
    void add_property(const wchar_t* name, const wchar_t* val,
  ...
  private:
    ...
    void parse_short_border(const std::wstring& prefix,
			    const std::wstring& val);
    void parse_short_background(const std::wstring& val,
				const wchar_t* baseurl);
