...
#define  font_variant_strings		L"normal;small-caps"
  ...
  enum font_variant {
    font_variant_normal, font_variant_italic
  };
...
#define  background_attachment_strings	L"scroll;fixed"
  ...
  enum background_attachment {
    background_attachment_scroll, background_attachment_fixed
  };
...
#define  background_box_strings	L"border-box;padding-box;content-box"
  ...
  enum background_box {
    background_box_border, background_box_padding, background_box_content
  };
