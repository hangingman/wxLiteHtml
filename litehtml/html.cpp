...
int litehtml::value_index(const wchar_t* val, const wchar_t* strings,
			  int defValue, const wchar_t* delim) {
...
int litehtml::value_in_list(const wchar_t* val, const wchar_t* strings,
			    const wchar_t* delim) {
