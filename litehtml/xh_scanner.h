#ifndef _XH_SCANNER_H_
#define _XH_SCANNER_H_
...
public:
	enum token_type {
		...
		TT_DOCTYPE_START,
		TT_DOCTYPE_END, // after "<!DOCTYPE" and ">"
	};
...
public:
	...
	scanner(instream& is) :
			input(is), input_char(0), value_length(0), tag_name_length(0), attr_name_length(
					0), got_tail(false) {
